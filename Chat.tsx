        ...
        <div className="flex space-x-3">
          <div className="flex-1 relative">
            <textarea
              ...
              className="w-full h-[88px] bg-gray-950 border border-gray-800 rounded-lg px-4 py-2 text-gray-100 placeholder-gray-500 resize-none focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 shadow-sm font-mono text-sm leading-relaxed"
          ...
          <div className="flex flex-col space-y-2">
            <button
              ...
              className="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
            >
            ...
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-green-500 to-green-400 hover:from-green-600 hover:to-green-500 disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-all duration-200 flex items-center justify-center space-x-2"
            >
